...
TweenMax.set($("g#atom"),{x:1000, y:"-=180",autoAlpha:0})
TweenMax.set($("g#literature"),{x:1000, y:"+=50",autoAlpha:0})
TweenMax.set($("g#dog"),{x:1000, y:"+=50",autoAlpha:0})
...
//groups
  ...
  .to($("#atom"),.2,{x:0,autoAlpha:1,ease:Power4.easeOut},"group1+=.7")
  ...
  .to($("#atom"),.2,{x:-2000,autoAlpha:0,ease:Power4.easeOut},"group2+=1.7")
  .to($("#literature"),.2,{x:0,autoAlpha:1,ease:Power4.easeOut},"group2+=1.7")
  ...
  .to($("#literature"),.2,{x:-2000,autoAlpha:0,ease:Power4.easeOut},"group3+=1.7")
  .to($("#dog"),.2,{x:0,autoAlpha:1,ease:Power4.easeOut},"group3+=1.7")
...
//organize
  ...
  .to($("#dog"),.2,{x:-2000,autoAlpha:0,ease:Power4.easeOut},"organizeStart")
